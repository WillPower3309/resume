...
\begin{itemize}
    ...
    \item Delivered SwayFX, an enhanced fork of Sway with visual aesthetics. The fork has amassed over 2300 stars on GitHub and an estimated 10,000 users across 14 Linux distributions.
\end{itemize}
...
\begin{itemize}
    ...
    \item Created SceneFX, a drop-in renderer capable of rendering with advanced visuals across the wlroots ecosystem that has been adopted by at least 4 wayland compositors that total over 6000 stars on GitHub.
\end{itemize}
